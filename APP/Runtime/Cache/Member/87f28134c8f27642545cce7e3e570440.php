			...
			<div class="row">
				...
				<div class="span9">
					  ...
					  <div class="bs-example">
					  		...
					  		<?php if(is_array($information)): $i = 0; $__LIST__ = $information;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="control-group">
								<label class="control-label" for="input01">社团名:</label>
									</br>
								<div class="controls">
										
									<h4><?php echo ($vo["cname"]); ?></h4>
								</div>
							</div>	
							</br>
					...
					<div class="control-group">
								...
								<div class="controls">
									 ...
									 <img src="/bbs/Public/Uploads/<?php echo ($vo["cpicture"]); ?>" width="150" height="80" />
								</div>
							</div>	
							</br>
				
					<div class="control-group">
								<label class="control-label" for="input01">社团简介:</label>
									</br>
								<div class="controls">
										
									<h4><?php echo ($vo["csummary"]); ?></h4>
								</div>
							</div>	
							</br>
