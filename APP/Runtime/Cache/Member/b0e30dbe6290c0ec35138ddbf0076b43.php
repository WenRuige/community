			...
			<div class="row">
				...
				<div class="span9">
					  ...
					  <div class="bs-example">
						...
						<?php if(is_array($members)): $i = 0; $__LIST__ = $members;if( count($__LIST__)==0 ) : echo "暂时没有数据请点击账户设置完善个人信息" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="control-group">
