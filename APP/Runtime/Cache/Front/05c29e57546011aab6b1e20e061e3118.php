...
<!--头部代码结束-->
	...
	<div class="row">
	   ...
	   <div class="clearfix">
				...
				<div class="pull-left classifyDIV pt-10 my1D6597">社团新闻</div>
 ...
 <!--列表开始-->     
    ...
    <!--第一个-->        
<?php if(is_array($show)): $i = 0; $__LIST__ = $show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="label-div b-30 border-all pb-20 pt-5" style="position: relative; padding-left: 0;">
	...
	<p class="t-1"><?php echo ($vo["content"]); ?></p>
         ...
         <div class="clearfix">
        <a href="__APP__/Front/News/index/id/<?php echo ($vo["id"]); ?>" title="阅读全文" target="_blank" rel="bookmark" class="read-all pull-left">查看详情</a></div>
         </div>
    </div>
  </div>
      ...
      <!--右侧代码-->  
       <div class="span4">
            ...
            <div class="label-div t-20 border-all">
				<div class="l-15">
               		 <h3 class="label-title border-b b-15 small clearfix" style="padding-bottom: 14px;">社团成员</h3>
                </div>
				<div class="label-main tody-hot l-15" >
					<ul>
					  <li><a href="">姓名---性别--职位</li>
					  <?php if(is_array($members)): $i = 0; $__LIST__ = $members;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href=""><?php echo ($vo["mname"]); ?>--<?php echo ($vo["msex"]); ?>--<?php echo ($vo["mposition"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
