		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span9">
					...
					<?php if(is_array($student)): $i = 0; $__LIST__ = $student;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form id="picture_upload" class="form-horizontal" action="__URL__/do_settings" method="post" enctype="multipart/form-data">
						<fieldset>
							<legend>个人信息</legend>
						...
						<!--	<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
							<div id="preview">
									<img id="imghead"class="img-rounded" src="/bbs/Public/Uploads/<?php echo ($vo["mpicture"]); ?>" width=150 height=200 border=0 >
								</div>
