				...
				<div class="span9">
					...
					<table class="table table-bordered table-striped">
						...
						<?php if(is_array($members)): $i = 0; $__LIST__ = $members;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									<a href="__APP__/Home/Singleshow/index/id/<?php echo ($vo["id"]); ?>" class="view-link">查看</a> <!--<img src="/bbs/Public/Uploads/<?php echo ($vo["mpicture"]); ?>" width="30" height="20" />--->
								</td>
								<td>
									<a href="__APP__/Home/Altershow/index/id/<?php echo ($vo["id"]); ?>" class="view-link">更改</a> <!--<img src="/bbs/Public/Uploads/<?php echo ($vo["mpicture"]); ?>" width="30" height="20" />--->
								</td>
