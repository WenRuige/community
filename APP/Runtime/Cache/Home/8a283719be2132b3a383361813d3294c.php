		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span9">
					...
					<?php if(is_array($show)): $i = 0; $__LIST__ = $show;if( count($__LIST__)==0 ) : echo "暂时没有数据请点击账户设置完善个人信息" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form action="__URL__/do_power" method="post">
					...
					<div class="control-group">
							...
							<button >提交</button>
							</form><?php endforeach; endif; else: echo "暂时没有数据请点击账户设置完善个人信息" ;endif; ?>
