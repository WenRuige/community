...
time char(30) not null
					...
					<a class="toggle-link" href="#message-reply1"><i class="icon-plus"></i>添加</a>
					<form id="message-reply1" class="form-horizontal hidden" method="post" action="__URL__/do_messages">
						<fieldset>
							<legend></legend>
							...
							<div class="form-actions">
								<button type="submit" class="btn btn-primary">添加</button> <button class="btn">取消</button>
							</div>
						</fieldset>
					</form>
					<!---<div class="page_list">
