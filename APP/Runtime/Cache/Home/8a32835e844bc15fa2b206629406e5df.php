		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span9">
					...
					<?php if(is_array($club)): $i = 0; $__LIST__ = $club;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form id="picture_upload" class="form-horizontal" action="__URL__/do_message" method="post" enctype="multipart/form-data">
						<fieldset>
							<legend></legend>
							<div class="control-group">
								<label class="control-label" for="input01">系名:</label>
								<div class="controls">
								<?php echo ($vo["cname"]); ?>
								</div>
							</div>
						...
						<!--	<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
							<div id="preview">
									<img  src="/bbs/Public/Uploads/<?php echo ($vo["cpicture"]); ?>"id="imghead"class="img-rounded" width=150 height=230 border=0 >
								</div>
							...
							<input class="input-file" name="file" type="file" onchange="previewImage(this)" />
								...
								<div class="controls">
									<textarea class="input-xlarge" id="textarea" rows="4" name="content"><?php echo ($vo["content"]); ?></textarea>
								</div>
							</div>	
