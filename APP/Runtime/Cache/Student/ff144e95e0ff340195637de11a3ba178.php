		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span9">
					...
					<form id="picture_upload" class="form-horizontal" action="__URL__/do_profile" method="post" enctype="multipart/form-data">
						<fieldset>
							<legend>个人信息</legend>
							<div class="control-group">
								<label class="control-label" for="input01">姓名</label>
								<div class="controls">
									<input type="text" class="input-xlarge" name="sname" id="input01" value="title" />
								</div>
							</div>
						...
						<!--	<div class="control-group">
							...
							&nbsp;&nbsp;<input type="radio" name="sex" id="optionsRadios2" value="女"> 女
								...
								<div class="controls">
									<input type="text" class="input-xlarge" name="sphone" id="input01" value="title" />
								</div>
							</div>				
							<div class="control-group">
								<label class="control-label" for="input01">电子邮箱</label>
								<div class="controls">
									<input type="text" class="input-xlarge" name="semail" id="input01" value="title" />
								</div>
							</div>	
								<div class="control-group">
								<label class="control-label" for="input01">入学年份</label>
								<div class="controls">
									<input type="text" class="input-xlarge" name="JoinYear" id="input01" value="title" />
								</div>
							</div>	
