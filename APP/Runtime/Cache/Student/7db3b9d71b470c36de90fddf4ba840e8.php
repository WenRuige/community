				...
				<div class="span3">
					<div class="well" style="padding: 8px 0;">
						<ul class="nav nav-list">
							...
							<li class="active">
								<a href="__APP__/Student/Apply/index"><i class="icon-white icon-home"></i>申请加入</a>
							</li>
							<!--<li>
				...
				<div class="span9">
					...
					<div class="control-group">
								...
								<div class="controls">
									 ...
									 <img src="/bbs/Public/Uploads/<?php echo ($vo["spicture"]); ?>" width="150" height="80" />
								</div>
							</div>	
							</br>
			       ...
			       <!--<div class="col-md-6">		          	
					...
					<!--<div class="hero-unit">
						...
						<p>
							<a href="" class="btn btn-primary btn-large">申请加入</a> 
						</p>
					</div>--->
