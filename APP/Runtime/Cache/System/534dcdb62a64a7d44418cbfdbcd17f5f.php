...
<html lang="en"><!--<![endif]--> 
	<head>
		...
		function agree($tid){
					...
					$.post('__APP__/System/Solve/add',{tid:$tid},function(json){
					});
		
					document.getElementById($tid).innerHTML="";
				}
				function refuse($tid){
				   $.post('__APP__/System/Solve/delete',{tid:$tid},function(json){
				   });
						document.getElementById($tid).innerHTML="";
			...
			<div class="row">
				...
				<div class="span9">
					...
					<table class="table table-bordered table-striped">
						...
						<?php if(is_array($temp)): $i = 0; $__LIST__ = $temp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody id="<?php echo ($vo["tid"]); ?>">
							...
							<tr>
								...
								<td>
								<?php echo ($vo["sdepartment"]); ?>
								</td>
								<td>
								<?php echo ($vo["sphone"]); ?>
								</td>
								<td>
									<a href="__APP__/System/Detailed/index/id/<?php echo ($vo["tid"]); ?>" >查看</a>
								</td>
								<td>
