...
//                 img.style.marginLeft = rect.left+'px';
	...
	<body>
		...
		<h4>首页新闻添加</h4>
              <form id="picture_upload" class="form-horizontal" action="__URL__/do_news" method="post" enctype="multipart/form-data">
						<fieldset>
							<legend></legend>
					...
					<!--<div class="hero-unit">
						...
						<p>
							<a href="help.php" class="btn btn-primary btn-large">Start Tour</a> <a class="btn btn-large">No Thanks</a>
						</p>
					</div>-->
