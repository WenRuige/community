	...
	<body>
		<div class="container">
			...
			<div class="row">
				...
				<?php if(is_array($tclub)): $i = 0; $__LIST__ = $tclub;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h4>姓名:<?php echo ($vo["sname"]); ?> &nbsp;&nbsp;&nbsp;&nbsp;联系方式:<?php echo ($vo["sphone"]); ?>&nbsp;&nbsp;专业-年级-班级:<?php echo ($vo["sdepartment"]); ?></h4>
					...
					<div class="control-group">
								<label class="control-label" for="input01">申请理由:</label>
