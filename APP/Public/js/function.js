...
var loadding = '<div class="clearfix center loaddingD fcccc"><img src="/images/loadding.gif" /> </div>';
var loaddingImg = '<img class="l-5 r-5 loaddingD" style="width:16px; height:11px;" src="/images/loadding.gif" />';
var loaddingL = function(o){if(!o){o='padding:0 10px;';}return '<span style="'+o+'" class="left loaddingD fcccc"> </span>';};
var loaddingP = function(o){if(!o){o='left:43%;';}return '<span style="position: absolute; top:0; '+o+'" class="loaddingD fcccc"> </span>';};
var loaddingP2 = function(o){if(!o){o='left:43%;';}return '<span style="position: absolute; top:0; '+o+'" class="loaddingD fcccc"></span>';};
...
var share_plug = function(obj, http){
	...
	if(String(islogin) == "0")
	{
	returnInfo(-1, 0, '<a target="_blank" href="/login.html?url='+back_url+'">立即登录</a>');
	return false;
}
...
AjaxHotags = function (hotTagsUrl){
	$('.hot_tags').html('<div class="pl-20 fc999"><img src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxPeople = function (peopleUrl){
	$('.common_list').html('<div class="pl-20 fc999"><img src="http://www.biodiscover.com/images/1.gif"> </div>');
	var type = $("#current-type").val();
...
AjaxLikeGroup = function (groupUrl){
	$('#group_like').html('<div class="pl-20 fc999"><img src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxPartEvent = function (eventUrl){
	$('#event_part').html('<div class="pl-20 fc999"><img src="http://www.biodiscover.com/images/1.gif"> </div>');
 ...
 **/
 AjaxMore = function(morelikeUrl){
	$('#more_like').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
 ...
 **/
 AjaxMorecomment = function(morecommentUrl){
	$('#more_comment').html('<div class="pl-20 fc999">');
...
AjaxRelationList = function(relationUrl){
	$('#relation_news').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxRelationTopic = function(relationUrl){
	$('#loader').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$('#loader').show();
	$.ajax({
		type:'get',
		url:relationUrl,
...
AjaxRelationTalk = function(relationUrl){
	$('#relation_talk').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxRelationDoc = function(relationDocUrl){
	$('.relation-div').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxRelationColl = function(relationCollUrl){
	$('.rel_coll_div').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxRelationImg = function(relationImgUrl){
	$('.relation_img').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxRelationImgColl = function(relationImgCollUrl){
	$('.relation_img_coll').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxRelationVideo = function(relationVideoUrl){
	$('.relation_video').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxRelationVideoColl = function(relationVideoCollUrl){
	$('.relation_video_coll').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxRelationEventTopic = function(relationUrl){
	$('#relation_event_topic').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxPush = function(pushUrl){
	$('#edit_push').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxHotTopic = function(hottopicUrl){
	$('#hot_topic').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:hottopicUrl,
		dataType:'html',
...
AjaxToppeopleevent = function(topeventUrl){
	$('#top_group').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:topeventUrl,
		dataType:'html',
...
AjaxEventbegin = function(eventBeginUrl){
	$('#event_begin').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:eventBeginUrl,
		dataType:'html',
...
AjaxTopevent = function(topUrl){
	$('#top_event').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:topUrl,
		dataType:'html',
...
AjaxRecommendEvent = function(recommendUrl){
	$('#recommend_event').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:recommendUrl,
		dataType:'html',
...
AjaxRecommendGroup = function(rGroupUrl){
	$('#recommend_group').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:rGroupUrl,
		dataType:'html',
...
AjaxTopGroup = function(topicurl){
	$('#topic_group').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:topicurl,
		dataType:'html',
...
AjaxPointList = function(pointUrl){
	$('.expert-points').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxLiteratureList = function(literatureUrl){
	$('.literature-list').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxEventMember = function(eventmemberUrl){
	$('#event_member').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:eventmemberUrl,
		dataType:'html',
...
AjaxRecommend = function(topicRecommendUrl){
	$('#recommend_topic').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
...
AjaxActiveMember = function(activeMemberUrl){
	$('#active_list').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:activeMemberUrl,
		dataType:'html',
...
AjaxGogroup = function(goGroupUrl){
	$('#go_group').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:goGroupUrl,
		dataType:'html',
...
AjaxGoevent = function(goEventUrl){
	$('.go_event').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:goEventUrl,
		dataType:'html',
...
AjaxEventReport = function(eventReportUrl){
	$('.report_event').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
	$.ajax({
		type:'get',
		url:eventReportUrl,
		dataType:'html',
...
AjaxTopicsource = function(sourceUrl){
	$('#topic_source').html('<div class="pl-20 fc999"><img alt="" src="http://www.biodiscover.com/images/1.gif"> </div>');
...
AjaxDocumentHotags = function (documentTagsUrl){
	$('.documment_hot_tags').html('<div class="pl-20 fc999"><img src="http://www.biodiscover.com/images/1.gif"> </div>');
	var type = $("#current-type").val();
	var tag = $("#current-tag").val();
...
AjaxDocUpload = function (docuploadUrl){
	$('.doc_upload').html('<div class="pl-20 fc999"><img src="http://www.biodiscover.com/images/1.gif"> </div>');
	var type = $("#current-type").val();
...
AjaxDocdownload = function (docdownloadUrl){
	$('.doc_download').html('<div class="pl-20 fc999"><img src="http://www.biodiscover.com/images/1.gif"> </div>');
	var type = $("#current-type").val();
